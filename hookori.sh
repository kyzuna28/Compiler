#!/bin/bash
# Patches authors: backslashxx @Github, weishu <twsxtd@gmail.com>, F-19-F @ Github
# Shell author: JackA1ltman <cs2dtzq@163.com>
# Tested kernel versions: 5.4, 4.19, 4.14, 4.9
# Merged and cleaned script - 2025
...
for i in "${patch_files[@]}"; do
    ...
    if grep -q "ksu" "$i"; then
        echo "Warning: $i contains KernelSU. Skipping patch for this file."
        continue
    fi
...
echo "KernelSU patch script execution finished."
